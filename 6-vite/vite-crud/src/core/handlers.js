...
import { createRecord, removeRecord, renderRecord } from "./records";
import {
  createCourseForm,
  editCourseForm,
  editDrawer,
        ...
        recordGroup.innerHTML = `
            <tr>
              <td colspan="5" class="text-center px-6 py-4">
                  Not Found <a class="underline text-blue-600" href='http://${location.host}'>See all</a>
              </td>
            </tr>
          `;
