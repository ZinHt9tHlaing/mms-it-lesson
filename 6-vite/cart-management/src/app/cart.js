...
export const createCartUi = ({ id, price, image, title }) => {
  ...
  cart.innerHTML = `
    ...
    />
    <div
      class="border shadow p-4 pt-12 bg-white border-neutral-500 text-neutral-700 relative"
    >
    <button class='cart-remove-btn absolute top-4 right-4 opacity-0 duration-300 translate-x-10 group-hover:opacity-100 group-hover:translate-x-0'>
        <svg
